...
namespace Курсовая_работа
{
    public partial class ReportPremium : Form
    {
        ...
        private void ReportPremium_Load(object sender, EventArgs e)
        {
        ...
        private void drawing1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                wordDocument.SaveAs(@"C:\Users\shtok\OneDrive\Рабочий стол\'" + textBox8.Text + "'.docx");
                wordDocument.Close();
                Process.Start(@"C:\Users\shtok\OneDrive\Рабочий стол\'" + textBox8.Text + "'.docx");
